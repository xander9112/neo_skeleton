...
class _$_AuthModel extends _AuthModel {
  const _$_AuthModel({required this.id, this.title}) : super._();
  ...
  @override
  String toString() {
    return 'AuthModel(id: $id, title: $title)';
  }
...
abstract class _AuthModel extends AuthModel {
  const factory _AuthModel({required final int id, final String? title}) =
      _$_AuthModel;
