...
class _$_ProfileModel extends _ProfileModel {
  const _$_ProfileModel({required this.id, this.title}) : super._();
  ...
  @override
  String toString() {
    return 'ProfileModel(id: $id, title: $title)';
  }
...
abstract class _ProfileModel extends ProfileModel {
  const factory _ProfileModel({required final int id, final String? title}) =
      _$_ProfileModel;
