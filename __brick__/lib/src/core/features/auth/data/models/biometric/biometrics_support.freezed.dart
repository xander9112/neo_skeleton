...
mixin _$BiometricSupportModel {
  ...
  BiometricItemType? get type => throw _privateConstructorUsedError;
...
abstract class $BiometricSupportModelCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {BiometricStatus status, BiometricItemType? type, bool? useBiometric});
}
