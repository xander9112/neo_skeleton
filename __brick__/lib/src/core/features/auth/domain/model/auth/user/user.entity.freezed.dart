...
class _$_AuthenticatedUser extends _AuthenticatedUser {
  ...
  @override
  String toString() {
    return 'AuthenticatedUser(id: $id, login: $login, lastName: $lastName, firstName: $firstName, patronymic: $patronymic, birthday: $birthday, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
