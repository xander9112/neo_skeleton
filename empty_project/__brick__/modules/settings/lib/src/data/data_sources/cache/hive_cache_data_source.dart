...
// class HiveSettingsCacheDataSource implements SettingsCacheDataSource {
//   HiveSettingsCacheDataSource();
...
//       .asyncMap<List<StoryObjectModel>>((_) => getSettings());
...
//   @override
//   Future<List<StoryObjectModel>> getSettings() async {
//     try {
